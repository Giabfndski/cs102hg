...
def event_handler(world: World) -> None:
    """
    Logics for some specific events in level 4.
    """
    for event in world.events:
        npc_chu_nhan_id = world.get_entity_id_by_type(EntityType.NPC_THAY_TU)
        npc_chu_nam_id = world.get_entity_id_by_type(EntityType.NPC_THAY_VINCENT)
